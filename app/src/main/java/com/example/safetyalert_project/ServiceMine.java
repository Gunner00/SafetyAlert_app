    ...
    public void onCreate() {
                ...
                .addOnSuccessListener(new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        if (location != null) {
                            ...
                            myLocation = "Unable to find your location";
                        }
                    }
                });
        ...
        ShakeDetector.create(this, () -> {
            ...
            if(!ENUM.equalsIgnoreCase("NONE")){
                manager.sendTextMessage(ENUM,null,"SOS! This is my last location, contact me ASAP:\n"+myLocation,null,null);
            }
        ...
        if (intent.getAction().equalsIgnoreCase("STOP")) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                ...
                Notification notification = new Notification.Builder(this, "MYID")
                        ...
                        .setContentText("Shake your device to send SOS")
